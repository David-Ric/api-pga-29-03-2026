...
namespace PortalGrupoAlyne.Migrations
{
    ...
    [Migration("20230606104345_logAcao")]
    partial class logAcao
    {
            ...
            modelBuilder.Entity("PortalGrupoAlyne.Model.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 95, 134, 17, 120, 209, 19, 245, 81, 213, 238, 250, 138, 216, 34, 199, 68, 221, 69, 248, 169, 0, 25, 247, 138, 145, 176, 236, 103, 220, 101, 107, 187, 54, 224, 132, 147, 226, 155, 249, 173, 150, 182, 242, 53, 167, 82, 146, 192, 231, 91, 126, 0, 144, 102, 41, 202, 82, 35, 40, 94, 217, 244, 63, 19 },
                            PasswordSalt = new byte[] { 63, 215, 5, 250, 47, 95, 22, 4, 205, 66, 154, 148, 25, 38, 67, 166, 51, 205, 253, 146, 39, 111, 231, 62, 220, 225, 210, 33, 164, 21, 21, 110 },
