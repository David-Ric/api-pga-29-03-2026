...
namespace PortalGrupoAlyne.Migrations
{
    ...
    [Migration("20230619133411_TempoSessaoUsuer")]
    partial class TempoSessaoUsuer
    {
            ...
            modelBuilder.Entity("PortalGrupoAlyne.Model.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 69, 251, 136, 66, 189, 30, 196, 248, 94, 149, 132, 49, 102, 150, 107, 30, 31, 101, 188, 116, 40, 159, 188, 158, 118, 254, 123, 166, 142, 9, 152, 87, 74, 41, 214, 184, 44, 92, 46, 12, 42, 245, 243, 174, 248, 231, 71, 213, 19, 225, 227, 187, 228, 165, 39, 233, 156, 90, 50, 185, 233, 204, 185, 34 },
                            PasswordSalt = new byte[] { 75, 169, 12, 68, 87, 62, 42, 109, 23, 203, 61, 49, 254, 37, 50, 31, 248, 59, 126, 8, 147, 128, 218, 15, 61, 0, 130, 167, 57, 91, 102, 255 },
