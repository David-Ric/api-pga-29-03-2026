        ...
        public async Task<ActionResult> DeleteAllPages([FromServices] DataContext context)
        {
            try
            {
                ...
                new Logs { Id = 1, VersaoApi = "1.0.0", AtualizadoEm = DateTime.Now },
                 ...
                 new Logs { Id = 3, VersaoApi = "1.0.4", AtualizadoEm = DateTime.Now },
                 ...
                 new Logs { Id = 10, VersaoApi = "1.1.010", AtualizadoEm = DateTime.Now },
                  new Logs { Id = 11, VersaoApi = "1.1.011", AtualizadoEm = DateTime.Now },
                   new Logs { Id = 12, VersaoApi = "1.1.012", AtualizadoEm = DateTime.Now },
                    new Logs { Id = 13, VersaoApi = "1.1.013", AtualizadoEm = DateTime.Now },
                    new Logs { Id = 14, VersaoApi = "1.1.014", AtualizadoEm = DateTime.Now },
                    new Logs { Id = 15, VersaoApi = "1.1.015", AtualizadoEm = DateTime.Now },
                    new Logs { Id = 16, VersaoApi = "1.1.016", AtualizadoEm = DateTime.Now },
                    new Logs { Id = 17, VersaoApi = "1.1.017", AtualizadoEm = DateTime.Now },
                    new Logs { Id = 18, VersaoApi = "1.1.018", AtualizadoEm = DateTime.Now },
                };
